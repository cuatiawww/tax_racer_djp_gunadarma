var gameL = (function () {
	function gameL (car, place) {
		...
		s.background = new background(dataList[place]);
	...
	gameL.prototype.fadeIn = function () {
		var s = this;
	...
	gameL.prototype.addPauseBtn = function () {
		var s = this,
	...
	gameL.prototype.mouseUp = function (e) {
	...
	gameL.prototype.loop = function (e) {
