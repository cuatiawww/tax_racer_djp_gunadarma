...
function addLogoInterface() {
    // Initialize the logo transition
    transisiLogo();
}
...
function loadGame() {
    var loadData = [
        ...
        [
            ...
            { name: "logo1", path: "./images/logo1.png" },
            { name: "logo2", path: "./images/logo2.png" },
            { name: "logo3", path: "./images/logo3.png" },
